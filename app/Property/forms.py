...
class SearchForm(FlaskForm):
    ...
    property_type = SelectField('Property Type', choices=[('house', 'House'), ('apartment', 'Apartment')], validators=[Optional()])
    property_status = SelectField('Property Status', choices=[('for_sale', 'For Sale'), ('for_rent', 'For Rent')], validators=[Optional()])
